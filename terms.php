...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Terms & Condition of vStudy">
	<meta name="keywords" content="TERMS & CONDITIONS,vStudy">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0">
    <title>Terms & Condition|vStudy </title>
...
<br />
www.vstudy.in ("Website", "vStudy") is owned and operated by Bitsphere Infosystem Pvt Ltd ("vStudy"). The term "vStudy", "us","we",or "our" refer to Bitsphere 
Infosystem Pvt Ltd. The term "you", "your" refers to users and viewers of this site. Please read these terms and conditions carefully before using our website. By accessing this web site, you agree to abide by and be bound by the Terms and Conditions set forth. If you do not agree with any of these terms, you cannot use our site.

<h4>Privacy</h4>

Any information that you provide to us is subject to our Privacy Policy, which governs our collection and use of your information. You understand that through your use of the Services you consent to the collection and use (as set forth in the Privacy Policy) of this information.

<h4>Communication</h4>


When you visit vStudy or send e-mails to us, you are communicating with us electronically. You consent to receive communications from us electronically. We will communicate with you by e-mail or by posting notices on this site. You agree that all agreements, notices, disclosures and other communications that we provide to you electronically satisfy any legal requirement that such communications be in writing.

<h4>Copyright</h4>

All content included on this site, such as questions, answers, lessons, other textual material, graphics, logos, button icons, images, audio clips, digital downloads,data compilations, and software, is the property of vstudy or its licensors.The compilation of all content on this site is the exclusive property of vStudy, with copyright authorship for this collection by vStudy.

<h4>License And Site Access</h4>

vStudy grants you a limited period license to access and make personal use of this site and does not allow you to download (other than page caching) or modify it,or any portion of it, except with prior written consent of vStudy. This license does not include any resale or commercial use of this site or its contents: any collection and use of any product listings, descriptions, or prices: any derivative use of this site or its contents: any downloading or copying of account information for the benefit of another merchant: or any use of data mining, robots, or similar data gathering and extraction tools. This site or any portion of this site may not be reproduced, duplicated, copied, sold, resold, visited, or otherwise exploited for any commercial purpose without express written consent of vStudy.

<h4>Your User Account</h4>

If you use this site, you are responsible for maintaining the confidentiality of your account and password and for restricting access to your computer, and you agree to accept responsibility for all activities that occur under your account or password. vStudy and its associates reserve the right to refuse service, terminate accounts, remove or edit content, or cancel orders at their sole discretion.

<h4>Reviews, Comments, And Other Content</h4>

Visitors may post reviews, comments, and other content: and submit suggestions, ideas, comments, questions, or other information on the site including the Dail Quiz pages.vStudy does not guarantee the authenticity of such information and is not responsible for it either. If you do post content or submit material, and unless we indicate otherwise, you grant vStudy and its associates a nonexclusive, royalty-free, perpetual, irrevocable, and fully sublicensable right to use, reproduce,modify, adapt, publish, translate, create derivative works from, distribute, and display such content throughout the world in any media.

<h4>Product And Services Description</h4>

vStudy and its associates attempt to be as accurate as possible in the content and information provided on this site. However, vStudy does not warrant that or 
other content of this site is accurate, complete, reliable, current or error-free. We explicitly disclaim any responsibility for the correctness, accuracy, 
completeness or availability of information, content and materials found on sites that link to or from the Website. We cannot ensure that you will be happy with any products or services that you purchase from a third-party website that links to or from the Website or third-party information, content or materials contained on our Website. <br /><br />

All the content including videos and study material are either licensed from multiple content partners or owned by vStudy. Although every effort is made to ensure that vStudy licenses original content from its content partners, vStudy will not be held responsible if any of the licensed content violates the intellectual property rights of any third party. However, we are happy to discuss this with our content partners and resolve the issue if brought to our notice.<br /><br />

DISCLAIMER OF WARRANTIES AND LIMITATION OF LIABILITY : VSTUDY MAKES NO REPRESENTATIONS OR WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED, AS TO THE OPERATION OF THIS SITE OR THE INFORMATION, CONTENT, MATERIALS, OR PRODUCTS INCLUDED ON THIS SITE. YOU EXPRESSLY AGREE THAT YOUR USE OF THIS SITE IS AT YOUR SOLE RISK TO THE FULL EXTENT PERMISSIBLE BY APPLICABLE LAW. TO THE FULL EXTENT PERMISSIBLE BY APPLICABLE LAW, VSTUDY DISCLAIMS ALL WARRANTIES, EXPRESS OR IMPLIED, INCLUDING, BUT NOT LIMITED TO, IMPLIED WARRANTIES OF MERCHANTABILITY AND FITNESS FOR A PARTICULAR PURPOSE VSTUDY DOES NOT WARRANT THAT THIS SITE, ITS SERVERS, OR E-MAIL SENT FROM VSTUDY ARE FREE OF VIRUSES OR OTHER HARMFUL COMPONENTS. VSTUDY WILL NOT BE LIABLE FOR ANY DAMAGES OF ANY KIND ARISING FROM THE USE OF THIS SITE, INCLUDING, BUT NOT LIMITED TO DIRECT, INDIRECT, INCIDENTAL, PUNITIVE, AND CONSEQUENTIAL DAMAGES.

<h4>Cancellation & Refund Policy</h4>
We generally do not provide a refund as money can't be reversed from wallet. Hence, all payments will be final, unless otherwise mentioned on certain plans. However, if you feel that you have a valid reason for a refund, mail us your concern along with the order Id, your registered email and date of purchase. Any refund, if eligible, will be processed within 14 days(Business days) of receiving a refund/cancellation request.

<h4>Disputes</h4>

Any dispute relating in any way to your visit to vStudy or to products/services you purchase through vStudy or your having violated or threatened to violate 
vStudy’s intellectual property rights, then the same shall be submitted to arbitration of courts in Ranchi, India only.

<h4>Questions</h4>

If you have any questions regarding the Terms & Conditions set forth here, please email us at: contact@vstudy.in.

Continue to visit this page to be updated on any changes we make.<br /><br />
