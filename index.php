...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Most Relevant & trusted Online Test Series for BANK PO/CLERK(SBI,IBPS,RRB ), RAILWAYS,SSC(CGL & CHSL),INSURANCE with detailed Performance Analysis">
	<meta name="keywords" content="ONLINE TEST,ANALYTICS, BANK PO, BANK CLERK , IBPS, SBI,SSC CHSL , SSC CGL,RRB,INSURANCE,RAILWAYS">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0">
	<meta name="google-site-verification" content="YQ1NDdEP2SSAWZcUZiePIsqbVmE1sFLxKO7lZkR3X5k" />
    <title>Online Test Series/portal/analysis/ best for BANK PO/CLERK(SBI,IBPS,RRB ), RAILWAYS,SSC,Insurance |vStudy </title>
...
<script src="signvalidation.js?v=1.07"></script>
...
?>
	...
	<div id="demo-snackbar-example2" class="mdl-js-snackbar mdl-snackbar" style="z-index:1000">
	  ...
	  <span  class="mdl-layout--large-screen-only">
       ...
       <a href="#overview" class="mdl-layout__tab is-active "  style="margin-left:30px;" title="Online Test for BANK/SSC/Railways/Engineering." rel="canonical" >Home</a>
          <a href="videos.php?topic_id=8&subject_id=1&page=1" class="mdl-layout__tab" title="Online Video Lecture for BANK/SSC/Railways/Engineering."  >Videos</a>
          <a href="quizlist.php" class="mdl-layout__tab" title="Online English Comprehension Quiz for BANK/SSC/Railways/Engineering." >Daily Quiz</a>
		    <a href="#features" class="mdl-layout__tab" rel="canonical" title="Online Test features for BANK/SSC/Railways/Engineering." title="Online Test features for BANK/SSC/Railways/Engineering." >Features</a>
          <a href="#contactdiv" rel="canonical" class="mdl-layout__tab" title="Contact form for BANK/SSC/Railways/Engineering Enquiries." >Contact</a>
...
?>
		...
		<img src="headerlogo.png" alt="logo" style="width:60px;margin-left:90px;height:60px">
          <a href="index.php" class="mdl-layout__tab " style="border-bottom:1px dotted white;border-top:1px dotted white" title="Online Test for BANK/SSC/Railways/Engineering." rel="canonical">Home</a>
          <a href="videos.php?topic_id=8&subject_id=1&page=1" class="mdl-layout__tab" style="border-bottom:1px dotted white" title="Online Video Lecture for BANK/SSC/Railways/Engineering.">Videos</a>
...
<a href="javascript:void(0);" onclick="fbLogin()" id="fbLink1"><img src="fbsignu.jpg" alt="Fb Sign up" style="width:100%;height:40px"/></a>
</div>
 ...
 <!-- Container with the Sign-In button. -->
    <div id="gConnect1" class="button">
      <button style="background-color:white;outline:none;border:none;cursor:pointer" class="g-signin"
          ...
          data-theme="dark"
          data-cookiepolicy="single_host_origin"><img src="gsignu.png?v=1.01" alt="Google Sign up" style="width:85%;height:45px" alt="google sign-in"  />
      </button>
 </div>
 </div>
...
<?php
 ...
 ?> 
      <main class="mdl-layout__content" >
        ...
        <div class="mdl-layout__tab-panel is-active " id="overview" style="margin-top:-47px;margin-left:-0.6%;width:102%">
		<div class="mdl-grid" align="center" style="height:550px;background-image:url('banner-exam2.jpg');background-size:100% 100% ; background-repeat:no-repeat;opacity:1" title="Crack your Bank PO/CLERK(SBI IBPS RRB) SSC(CGL/CHSL) RAILWAYS INSURANCE online test/exam with vStudy">
		<div class=" mdl-cell mdl-cell--12-col mdl-cell--8-col-tablet mdl-cell--8-col-phone" align="center">
		<br /><br />
		<h2 style="color:white">CRACK YOUR EXAM </h2>
		<div class=" mdl-cell mdl-cell--3-col mdl-cell--8-col-tablet mdl-cell--8-col-phone" align="center">
		
		</div>
		<div class=" mdl-cell mdl-cell--6-col mdl-cell--8-col-tablet mdl-cell--8-col-phone" align="center">
		<br />
		<p style="color:white;font-size:18px">We don't sell any package instead you create it according to your own need !</p>
		<br/>
		<p style="color:white">Online test series for BANK/SSC/Railways designed by <span style="font-size:18px">IITians</span></p> 
		 
		
		</div>
		<div class=" mdl-cell mdl-cell--12-col mdl-cell--8-col-tablet mdl-cell--8-col-phone" align="center">
		<br />
		<a id = "abc" href="#steps" class="mdl-button mdl-js-button mdl-button--raised  mdl-button--colored" style="width:250px;font-size:22px;height:50px;border-radius:20px;text-decoration:none;margin-top:10px"><span style="position:relative;top:7px;">HOW IT WORKS</span></a>
		<?php
		if(isset($_SESSION['username']) && isset($_SESSION['password']))
{
	?>
	
	<a href="home.php" class="mdl-button mdl-js-button mdl-button--raised  mdl-button--colored" style="width:250px;font-size:22px;height:50px;border-radius:20px;text-decoration:none;margin-left:20px;margin-top:10px"><span style="position:relative;top:7px;">GO TO DASHBOARD</span></a><?php
}	
?>
		</div>
		</div>
...
<div class="mdl-grid" id="steps" >

<div class=" mdl-cell mdl-cell--12-col mdl-cell--8-col-tablet mdl-cell--8-col-phone" align="center">
<br /><br />
<h4 style="font-weight:bolder">HOW IT WORKS </h4>
</div>
<div class=" mdl-shadow--2dp mdl-cell mdl-cell--3-col mdl-cell--8-col-tablet mdl-cell--8-col-phone" align="center" title="Recharge Your vS Wallet">
   <h5><b>STEP 1</b></h5>
<a style="text-decoration:none;color:grey" href="demo4.jpg" data-lightbox="howitworks"><div class="demo-card-wide mdl-card mdl-cell mdl-cell--12-col" style=" background: url('demo4.jpg') ; background-size:100% 80%;background-repeat:no-repeat;">
 ...
 <div class=" mdl-shadow--2dp mdl-cell mdl-cell--3-col mdl-cell--8-col-tablet mdl-cell--8-col-phone" align="center" title="Select & Add mocks to your container acording to your need">
   <h5><b>STEP 2</b></h5>
  <a style="text-decoration:none;color:grey" href="demo1.jpg" data-lightbox="howitworks"><div class="demo-card-wide mdl-card mdl-cell mdl-cell--12-col "style=" background: url('demo1.jpg') ; background-size:100% 80%;background-repeat:no-repeat;">
  ...
  <div class="mdl-card__actions mdl-card--border" align="center" >
      ...
      <b>Select and Add Mocks to your container.</b>
...
<div class=" mdl-shadow--2dp mdl-cell mdl-cell--3-col mdl-cell--8-col-tablet mdl-cell--8-col-phone" align="center" title="Mock is added to your wallet">
   <h5><b>STEP 3</b></h5>
<a style="text-decoration:none;color:grey" href="demo2.jpg" data-lightbox="howitworks"><div class="demo-card-wide mdl-card mdl-cell mdl-cell--12-col" style=" background: url('demo2.jpg') ; background-size:100% 80%;background-repeat:no-repeat;">
  <div class="mdl-card__title">
    <h2 class="mdl-card__title-text"></h2>
  </div>
  ...
  <div class="mdl-card__actions mdl-card--border" align="center">
      ...
      <b>Mocks are added and price is deducted from the wallet.</b>
 ...
 <div class=" mdl-shadow--2dp mdl-cell mdl-cell--3-col mdl-cell--8-col-tablet mdl-cell--8-col-phone" align="center" title="Take Bank/SSC/Railway/SSC mocks based on latest pattern">
   <h5><b>STEP 4</b></h5>
 <a style="text-decoration:none;color:grey" href="demo3.jpg" data-lightbox="howitworks"> <div class="demo-card-wide mdl-card mdl-cell mdl-cell--12-col "style=" background: url('demo3.jpg') ; background-size:100% 80%;background-repeat:no-repeat;">
  ...
  <div class="mdl-card__actions mdl-card--border" align="center">
      ...
      <b>Click on Mock Test Tab & Take the Mock Test added by you.</b>
