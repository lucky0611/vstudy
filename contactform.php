...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Online Test Enquiry Form for BANK PO/CLERK(SBI,IBPS,RRB ), RAILWAYS,SSC(CGL & CHSL),INSURANCE with detailed Performance Analysis">
	<meta name="keywords" content="ONLINE TEST,Enquiry Form, BANK PO, BANK CLERK , IBPS, SBI,SSC CHSL , SSC CGL,RRB,INSURANCE,RAILWAYS">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0">
    <title>Online Test Enquiry Form best for BANK PO/CLERK(SBI,IBPS,RRB ), RAILWAYS,SSC,Insurance |vStudy </title>
...
<script src="sliders/jquery.bxslider.min.js"></script>
<!-- bxSlider CSS file -->
<link href="sliders/jquery.bxslider.css" rel="stylesheet" />
...
?>
	...
	<div id="demo-snackbar-example2" class="mdl-js-snackbar mdl-snackbar" style="z-index:1000">
	  ...
	  <span  class="mdl-layout--large-screen-only">
       ...
       <a href="#overview" class="mdl-layout__tab  "  style="margin-left:30px;" title="Online Test for BANK/SSC/Railways/Engineering." >Home</a>
          ...
          <a href="quizlist.php"  class="mdl-layout__tab" title="Online English Comprehension Quiz for BANK/SSC/Railways/Engineering." >Daily Quiz</a>
		    <a href="#features" class="mdl-layout__tab " title="Online Test features for BANK/SSC/Railways/Engineering." title="Online Test features for BANK/SSC/Railways/Engineering." >Features</a>
          <a href="#contactdiv" class="mdl-layout__tab is-active" title="Contact form for BANK/SSC/Railways/Engineering Enquiries." >Contact</a>
...
?>
		...
		<img src="headerlogo.png" alt="logo" style="width:60px;margin-left:90px;height:60px">
          ...
          <a href="contactform.php" rel="canonical" class="mdl-layout__tab" style="border-bottom:1px dotted white" title="Contact form for BANK/SSC/Railways/Engineering Enquiries.">Contact</a>
...
<?php
 ...
 ?> 
      <main class="mdl-layout__content" >
        ...
        <div class="mdl-layout__tab-panel " id="overview" style="margin-top:-47px;margin-left:-0.6%;width:102%">
...
<a style="text-decoration:none;color:grey" href="demo2.jpg" data-lightbox="howitworks"><div class="demo-card-wide mdl-card mdl-cell mdl-cell--12-col" style=" background: url('demo2.jpg') ; background-size:100% 80%;background-repeat:no-repeat;">
  ...
  <div class="mdl-card__actions mdl-card--border" align="center">
      ...
      <b>Mocks is added and its price is deducted from wallet.</b>
 ...
 <a style="text-decoration:none;color:grey" href="demo3.jpg" data-lightbox="howitworks"> <div class="demo-card-wide mdl-card mdl-cell mdl-cell--12-col "style=" background: url('demo3.jpg') ; background-size:100% 80%;background-repeat:no-repeat;">
  ...
  <div class="mdl-card__actions mdl-card--border" align="center">
      ...
      <b>Take the added mock based on latest exam pattern.</b>
...
<div class=" mdl-layout__tab-panel md1-grid is-active" align="center" style="background-color:white" id="contactdiv" >
