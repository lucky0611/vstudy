...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Most Relevant & trusted Online Video Lectures Topic-wise for BANK PO/CLERK(SBI,IBPS,RRB ), RAILWAYS,SSC(CGL & CHSL),INSURANCE by IITians">
...
if(isset($_GET['topic_id']) && isset($_GET['subject_id']) && isset($_GET['page']))
{
...
$skip = ($getdata - 1)*6 ;
 $store = array();
  $query1 = "SELECT COUNT(*) AS total FROM video_store WHERE topic_id='$topics_id' ";
	 ...
	 <div id="demo-snackbar-example2" class="mdl-js-snackbar mdl-snackbar" style="z-index:1000">
	  ...
	  <span  class="mdl-layout--large-screen-only">
       ...
       <a href="index.php" class="mdl-layout__tab  "  style="margin-left:30px;"title="Online Test for BANK/SSC/Railways/Engineering." >Home</a>
          <a href="#videodiv" class="mdl-layout__tab is-active" title="Online Video Lecture for BANK/SSC/Railways/Engineering." >Videos</a>
...
?>
      ...
      <div class="mdl-layout__drawer mdl-color--primary" style="color:white;background-color:white" >
		<img src="headerlogo.png" alt="logo" style="width:60px;margin-left:90px;height:60px">
          ...
          <a href="#videodiv" class="mdl-layout__tab" style="border-bottom:1px dotted white" title="Online Video Lecture for BANK/SSC/Railways/Engineering.">Videos</a>
...
<div class="mdl-cell mdl-cell--3-col" style="border-right:1px dotted grey" >
<ul class="demo-list-item mdl-list">
<?php
$i = 1;
 $que = "SELECT * FROM qp_sections WHERE video_show = '1' " ;
...
?>
  ...
  <li class="mdl-list__item" >
	...
	<button id="demo-menu-lower-right<?php echo $i ; ?>"
        class="mdl-button mdl-js-button mdl-button--icon">
  <i class="material-icons">more_vert</i>
</button>&nbsp;
	...
	<?php
	$q = "SELECT * from qp_sections_topic WHERE qp_section_id = '$section_id' AND video_show = '1'  " ;
 $r = mysqli_query($con,$q);
 if(mysqli_num_rows($r) > 0)
 {
	 ?>
	 <ul class="mdl-menu  mdl-js-menu mdl-js-ripple-effect"
    for="demo-menu-lower-right<?php echo $i ; ?>">
	 <?php
 while($ro = mysqli_fetch_array($r))
 {
	 $topic_id= $ro['topic_id'];
 ?>
  <li class="mdl-menu__item"><a href="videos.php?topic_id=<?php echo $topic_id ;?>&subject_id=<?php echo $section_id ;?>" style="color:black;text-decoration:none"><?php echo $ro['topic'] ?></a></li>
...
<div class="mdl-cell mdl-cell--9-col" >
	<div class="mdl-grid" id="attachvid" >
	<?php
 ...
 ?>
 <div class="mdl-cell mdl-cell--12-col" align="right" style="margin-top:-20px" >
 <br />
 </div>
 <div class="mdl-cell mdl-cell--11-col" align="right" style="margin-top:-20px" >
 <?php
 $sql = "SELECT * FROM video_store WHERE topic_id='$topics_id' ORDER BY topic_id DESC LIMIT 0, 1";
	$result =mysqli_query($con,$sql);
	$row=mysqli_fetch_array($result);
	$video_id = $row['video_id'];
 ?>
 <a target="_blank" rel="canonical" href="viewvideo.php?subject_id=<?php echo $subjects_id ?>&topic_id=<?php echo $topics_id ?>&video_id=<?php echo $video_id ?>" style="color:grey;text-decoration:none;font-size:20px" >Click here for Entire <?php echo $ro1['topic'] ; ?> Video List</a>
 </div>
 <div class="mdl-cell mdl-cell--12-col" align="right" style="margin-top:-20px" >
 <br /><br />
 </div>
 <div class="mdl-cell mdl-cell--12-col" align="center" style="margin-top:-20px" >
 <h4>
 <?php
 echo $ro2['section_name']."&nbsp;"."-"."&nbsp;"."<span style='color:grey;font-size:20px'>".$ro1['topic']."</span>" ;
 ?>
 </h4>
 </div>
 <?php
	$sql = "SELECT * FROM video_store WHERE topic_id='$topics_id' ORDER BY topic_id DESC LIMIT $skip, 6";
	$result =mysqli_query($con,$sql);
	while ($row=mysqli_fetch_array($result)){
		  ...
		  array_push($store,$row);
			 ...
			 if(($total)%6 == 0)
			{
			$num_page = intval(($total)/6) ;
			}
			if(($total)%6 != 0)
			{
			$num_page = intval(($total)/6) + 1 ;
			}
	?>
...
<div class="demo-card-wide mdl-card mdl-shadow--2dp">
  ...
  ?>
 <iframe allowfullscreen="allowfullscreen" mozallowfullscreen="mozallowfullscreen" msallowfullscreen="msallowfullscreen" oallowfullscreen="oallowfullscreen" webkitallowfullscreen="webkitallowfullscreen" width="100%" height="200px" src="https://www.youtube.com/embed/<?php echo $link ;?>?controls=1">
</iframe>
  </div>
...
if($getdata != $num_page)
{
  ...
  ?>
  <div class="mdl-grid" >
   <div class="mdl-cell mdl-cell--12-col" align="center" style="margin-top:40px" >
<?php
if($prev != 0)
{
?>
...
<?php
 ...
 {
 ?>
      <a style="width:30px;color:white;text-decoration:none" href="videos.php?topic_id=8&subject_id=1&page=<?php echo $prev ?>"   class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--colored"  id="markp" aria-label="Previous">
...
{
	?>
<a style="width:30px;color:white;text-decoration:none" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--colored" href="videos.php?topic_id=8&subject_id=1&page=<?php echo $i ?>" id="mark<?php echo $i?>" ><?php echo $i ?></a>
<?php
}
}
else if($num_page <= 5)
...
{
	?>
<a style="width:30px;color:white;text-decoration:none" href="videos.php?topic_id=8&subject_id=1&page=<?php echo $i ?>"  class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--colored" id="mark<?php echo $i?>" ><?php echo $i ?></a>
<?php
}
}
if($nex != 0 && $num_page!= 0)
...
?>
 ...
 {
 ?>
      <a style="width:30px;color:white;text-decoration:none" href="videos.php?topic_id=8&subject_id=1&page=<?php echo $nex ?>"  class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--colored" id="markn"  aria-label="Next">
...
?>
 ...
 <script>
document.getElementById("mark" + "<?php echo $getdata ?>").className = "mdl-button mdl-js-button mdl-button--raised mdl-button--accent"
