...
<!DOCTYPE html>
  ...
  <head>
    ...
    <meta name="description" content="Most Relevant Online English Comphrehension Quiz for BANK PO/CLERK(SBI,IBPS,RRB ), RAILWAYS,SSC(CGL & CHSL),INSURANCE ">
    ...
    <title>Online English Comphrehension Quiz/Question best for BANK PO/CLERK(SBI,IBPS,RRB ), RAILWAYS,SSC,Insurance |vStudy </title>
	...
	<div id="demo-snackbar-example2" class="mdl-js-snackbar mdl-snackbar" style="z-index:1000">
	  ...
	  <span  class="mdl-layout--large-screen-only">
       ...
       <a href="index.php" class="mdl-layout__tab  "  style="margin-left:30px;" title="Online Test for BANK/SSC/Railways/Engineering." >Home</a>
          ...
          <a href="quizlist.php" class="mdl-layout__tab is-active" title="Online English Comprehension Quiz for BANK/SSC/Railways/Engineering." rel="canonical" >Daily Quiz</a>
...
?>
		...
		<img src="headerlogo.png" alt="logo" style="width:60px;margin-left:90px;height:60px">
          ...
          <a href="quizlist.php" class="mdl-layout__tab" style="border-bottom:1px dotted white" title="Online English Comprehension Quiz for BANK/SSC/Railways/Engineering." rel="canonical">Daily Quiz</a>
