...
<!DOCTYPE html>
  ...
  <head>
    ...
    <meta name="description" content="Most Relevant Online English Comphrehension Quiz Question-wise for BANK PO/CLERK(SBI,IBPS,RRB ), RAILWAYS,SSC(CGL & CHSL),INSURANCE ">
	<meta name="keywords" content="ONLINE QUIZ,ENGLISH COMPREHENSION, BANK PO, BANK CLERK , IBPS, SBI,SSC CHSL , SSC CGL,RRB,INSURANCE,RAILWAYS">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0">
    <title>Online English Comphrehension Quiz Question-wise best for BANK PO/CLERK(SBI,IBPS,RRB ), RAILWAYS,SSC,Insurance |vStudy </title>
...
?>
   <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
	<div id="demo-snackbar-example2" class="mdl-js-snackbar mdl-snackbar" style="z-index:1000">
      ...
      <header class="mdl-layout__header mdl-layout__header--fixed mdl-color--primary " id="headheight"  >
	  ...
	  <span  class="mdl-layout--large-screen-only">
       ...
       <a href="index.php" class="mdl-layout__tab  "  style="margin-left:30px;" title="Online Test for BANK/SSC/Railways/Engineering." >Home</a>
          ...
          <a href="quizlist.php" class="mdl-layout__tab is-active"  title="Online English Comprehension Quiz for BANK/SSC/Railways/Engineering." >Daily Quiz</a>
...
<?php
 ...
 ?> 
      <main class="mdl-layout__content" id="scrollpage">
...
.demo-card-square > .mdl-card__title {
  color: #fff;
  background:
bottom right 15% no-repeat #3f51b5;
}
</style>

<div class="demo-card-square mdl-card mdl-shadow--2dp">
  <div class="mdl-card__title mdl-card--expand">
    <h2 class="mdl-card__title-text">Quiz # <?php echo $quiz_id;?></h2>
  </div>
...
<div class="mdl-cell mdl-cell--10-col" style="font-weight:bold" >
	
<em><?php echo $store1[$j]['question'];?></em>
	</div>
	<div class="mdl-cell mdl-cell--1-col" >
	</div>
	</div>
 ...
 <div class="mdl-cell mdl-cell--1-col" >
   ...
   <div class="mdl-cell mdl-cell--10-col" ><?php echo $store1[$j]['two'];?></div>
      <div class="mdl-cell mdl-cell--1-col" >
 ...
 <div class="mdl-cell mdl-cell--1-col" >
	<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="option-3<?php echo $j; ?>">
      ...
      <div class="mdl-cell mdl-cell--10-col" ><?php echo $store1[$j]['three'];?></div>
       <div class="mdl-cell mdl-cell--1-col" >
 ...
 <div class="mdl-cell mdl-cell--1-col" >
	<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="option-4<?php echo $j; ?>">
	  <input type="radio" id="option-4<?php echo $j; ?>" class="mdl-radio__button" name="options<?php echo $j; ?>" value="D">
       ...
       <div class="mdl-cell mdl-cell--10-col" ><?php echo $store1[$j]['four'];?></div>
       <div class="mdl-cell mdl-cell--1-col" >
...
<br />
  ...
  <div class="mdl-card__menu">
     <span class="" data-href="http://www.vstudy.in/onlinetest/quiz.php?id=<?php echo $id?>" data-layout="button_count" data-size="small" data-mobile-iframe="true"><a class="fb-xfbml-parse-ignore mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fwww.vstudy.in%2Fonlinetest%2Fquiz.php%3Fid%3D<?php echo $id;?>%26quiz_id%3D<?php echo $z ;?>&amp;src=sdkpreparse"><svg style="width:24px;height:24px" viewBox="0 0 24 24">
  ...
  <br /><br />
  <div rel="nofollow" id="disqus_thread" class="mdl-cell mdl-cell--12-col"></div>
<script>
