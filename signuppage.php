...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Sign up form for Online Test Series BANK PO/CLERK(SBI,IBPS,RRB ), RAILWAYS,SSC(CGL & CHSL),INSURANCE with detailed Performance Analysis">
	<meta name="keywords" content="ONLINE TEST,SIGNUP FORM, BANK PO, BANK CLERK , IBPS, SBI,SSC CHSL , SSC CGL,RRB,INSURANCE,RAILWAYS">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0">
    <title>Sign up form for Online Test Series for BANK PO/CLERK(SBI,IBPS,RRB ), RAILWAYS,SSC,Insurance |vStudy </title>
...
?>
   ...
   {
	   ?>
	   <a href="signuppage.php" rel="canonical"  class="mdl-layout__tab"  style="border-bottom:1px dotted white;cursor:pointer">Sign Up</a>
...
<a href="javascript:void(0);" onclick="fbLogin()" id="fbLink"><img src="fblogin.png" alt ="FB Login" alt ="FB Login" style="width:100%;height:40px"/></a>
</div>
 ...
 <!-- Container with the Sign-In button. -->
    <div id="gConnect" class="button">
      <button style="background-color:white;outline:none;border:none;cursor:pointer" class="g-signin"
          ...
          data-theme="dark"
          data-cookiepolicy="single_host_origin"><img src="glogin.png?v=1.01" alt = "Google Login" alt = "Google Login" style="width:85%;height:45px" alt="google sign-in"  />
      </button>
 </div>
 </div>
