...
<!DOCTYPE html>
  ...
  <head>
    ...
    <meta name="description" content="Date-wise Most Relevant Online English Comphrehension Quiz for BANK PO/CLERK(SBI,IBPS,RRB ), RAILWAYS,SSC(CGL & CHSL),INSURANCE.">
	<meta name="keywords" content="ONLINE QUIZ,ENGLISH COMPREHENSION,DATE-WISE, BANK PO, BANK CLERK , IBPS, SBI,SSC CHSL , SSC CGL,RRB,INSURANCE,RAILWAYS
    <meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0">
    <title>Date-wise Online English Comphrehension Quiz/Question best for BANK PO/CLERK(SBI,IBPS,RRB ), RAILWAYS,SSC,Insurance |vStudy </title>
...
<div class="demo-card-square mdl-card mdl-shadow--2dp">
  ...
  <div class="mdl-card__actions mdl-card--border" id="v<?php echo $store[$i-1]['pass_id'];?>" >
    <a class="mdl-button  mdl-js-button mdl-js-ripple-effect" style="color:grey" href="quiz.php?id=<?php echo $store[$i-1]['pass_id'];?>&quiz_id=<?php echo $z ;?>">
      VIEW QUIZ
    </a>
  </div>
  <div class="mdl-card__menu">
    <span class="" data-href="http://www.vstudy.in/onlinetest/quiz.php?id=<?php echo $store[$i-1]['pass_id'];?>" data-layout="button_count" data-size="small" data-mobile-iframe="true"><a class="fb-xfbml-parse-ignore mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fwww.vstudy.in%2Fonlinetest%2Fquiz.php%3Fid%3D<?php echo $store[$i-1]['pass_id'];?>%26quiz_id%3D<?php echo $z ;?>&amp;src=sdkpreparse"><svg style="width:24px;height:24px" viewBox="0 0 24 24">
