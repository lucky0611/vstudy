  ...
  <div class="row" align="center">
	...
	$sqle = "SELECT * FROM subcourse_info WHERE course_id = '$course_id1' ";
		 ...
		 while($rowe = mysqli_fetch_array($resulte))
		 {
			...
			{
	?>
      <li><a href="testresult.php?subcourse_id=<?php echo $rowe['subcourse_id'] ?>&course_id=<?php echo $course_id1 ?> "><?php echo $rowe['subcourse_name'] ?></a></li>
       <?php
...
if(mysqli_num_rows($result) == 1)
{
   ...
   <p style="border:1px dotted grey;"><a style="color:black" href="viewtestanalytics.php?mock_id=<?php echo $row1['mock_id'] ; ?>" style="text-align:center;"><?php echo  $row1['mock_name'] ?></a></p>
   </div>
...
if(mysqli_num_rows($result5) == 1)
{
   ...
   <div class="col-xs-10" style="margin-bottom:20px;font-size:20px;text-align:center">
   <p style="border:1px solid grey"><a style="color:black" href="viewtestanalytics.php?mock_id=<?php echo $row2['mock_id'] ; ?>" style="text-align:center;"><?php echo  $row2['mock_name'] ?></a></p>
   </div>
  <?php
  $n++ ;
		  }
