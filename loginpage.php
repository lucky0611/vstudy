...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Login form for Online Test Series for BANK PO/CLERK(SBI,IBPS,RRB ), RAILWAYS,SSC(CGL & CHSL),INSURANCE with detailed Performance Analysis">
	<meta name="keywords" content="ONLINE TEST,LOGIN FORM, BANK PO, BANK CLERK , IBPS, SBI,SSC CHSL , SSC CGL,RRB,INSURANCE,RAILWAYS">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0">
    <title>Login form for Online Test Series for BANK PO/CLERK(SBI,IBPS,RRB ), RAILWAYS,SSC,Insurance |vStudy </title>
...
?>
		...
		<img src="headerlogo.png" alt="logo" alt="logo" style="width:60px;margin-left:90px;height:60px">
...
?>
   ...
   else
   {
	   ...
	   <a href="signuppage.php"  class="mdl-layout__tab"  style="border-bottom:1px dotted white;cursor:pointer">Sign Up</a>
		  <a  href="loginpage.php" class="mdl-layout__tab" rel="canonical"  style="border-bottom:1px dotted white;cursor:pointer">Login</a>
...
<a href="javascript:void(0);" onclick="fbLogin()" id="fbLink1"><img src="fbsignu.jpg" alt="Fb Signup" alt="Fb Signup" style="width:100%;height:40px"/></a>
</div>
 ...
 <!-- Container with the Sign-In button. -->
    <div id="gConnect1" class="button">
      <button style="background-color:white;outline:none;border:none;cursor:pointer" class="g-signin"
          ...
          data-theme="dark"
          data-cookiepolicy="single_host_origin"><img src="gsignu.png?v=1.01" alt ="Google Signup" alt ="Google Signup" style="width:85%;height:45px" alt="google sign-in"  />
      </button>
 </div>
 </div>
...
{
mdl_close('#demo-1');
document.getElementById("demo-2").style.display = "none";
...
<div class="mdl-grid" align="center" >
 <div class="mdl-cell mdl-cell--12-col">
 <p ><a onclick="showresmodal()"   id="forgotpass" style="color:grey;text-decoration:none;cursor:pointer">Forgot Your Password ?</a></p>
...
<!-- Facebook login or logout button -->
<a href="javascript:void(0);" onclick="fbLogin()" id="fbLink"><img src="fblogin.png" alt ="FB Login" alt ="FB Login" alt ="FB Login" style="width:100%;height:40px"/></a>
</div>
<div class="mdl-cell mdl-cell--2-col" align="center">
<p style="font-size:22px;margin-top:7px">OR</p>
 </div>
 ...
 <!-- Container with the Sign-In button. -->
    <div id="gConnect" class="button">
      <button style="background-color:white;outline:none;border:none;cursor:pointer" class="g-signin"
          ...
          data-callback="onSignInCallback"
          data-theme="dark"
          data-cookiepolicy="single_host_origin"><img src="glogin.png?v=1.01" alt = "Google Login" alt = "Google Login" alt = "Google Login" style="width:85%;height:45px" alt="google sign-in"  />
      </button>
 </div>
 </div>
...
<div class="mdl-cell mdl-cell--3-col" >
  ...
  <div class="mdl-grid" id="demo-3" align="center" style="display:none" >
  <div class="mdl-cell mdl-cell--12-col" >
  <div class="mdl-cell mdl-cell--3-col" >
  </div>
  <div class="mdl-cell mdl-cell--6-col">
