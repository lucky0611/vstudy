...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Online Test Features of BANK PO/CLERK(SBI,IBPS,RRB ), RAILWAYS,SSC(CGL & CHSL),INSURANCE with detailed Performance Analysis">
	<meta name="keywords" content="ONLINE TEST,Features, BANK PO, BANK CLERK , IBPS, SBI,SSC CHSL , SSC CGL,RRB,INSURANCE,RAILWAYS">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0">
    <title>Online Test Features best for BANK PO/CLERK(SBI,IBPS,RRB ), RAILWAYS,SSC,Insurance |vStudy </title>
	  ...
	  <span  class="mdl-layout--large-screen-only">
       ...
       <a href="#overview" class="mdl-layout__tab  "  style="margin-left:30px;" title="Online Test for BANK/SSC/Railways/Engineering." >Home</a>
          ...
          <a href="quizlist.php"  class="mdl-layout__tab" title="Online English Comprehension Quiz for BANK/SSC/Railways/Engineering." >Daily Quiz</a>
		    <a href="#features" class="mdl-layout__tab is-active" title="Online Test features for BANK/SSC/Railways/Engineering." title="Online Test features for BANK/SSC/Railways/Engineering." >Features</a>
...
?>
		...
		<img src="headerlogo.png" alt="logo" style="width:60px;margin-left:90px;height:60px">
		  ...
		  <a href="feature.php" class="mdl-layout__tab" rel="canonical" style="border-bottom:1px dotted white" title="Online Test features for BANK/SSC/Railways/Engineering.">Features</a>
